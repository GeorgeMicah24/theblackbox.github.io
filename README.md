...
<body>
    <div class="container">
        <h1>The Blackbox</h1>
        <img src="theblackimg.png" alt="Image of The Blackbox">
        ...
        <div class="documentation">
            <ul>
                <li><a href="TheBlackbox_ExecutiveSummary_Final.pdf">Executive Summary</a></li>
                <li><a href="AlternativeInstrumentation_ProblemStatement_Final.pdf">Problem Statement</a></li>
                <li><a href="TheBlackbox_DesignRequirementSpecifications_Final-6.pdf">Engineering Requirements</a></li>
                <li><a href="TheBlackbox_ApproachDocument_Final-1-1.pdf">Design Approach</a></li>
            </ul>
        </div>
        
        <h2>Meet The Team</h2>
        <p>&#9835; Alternative Instrumentation &#9835;</p>
        
        <div class="team-member">
            <img src="team1.jpg" alt="Cash Henderson">
            <p><strong>CASH HENDERSON</strong></p>
            <p>Team Lead & Digital FX Design Sub-Team Co-Lead</p>
        </div>
        
        <div class="team-member">
            <img src="team2.jpg" alt="Ian Avant">
            <p><strong>IAN AVANT</strong></p>
            <p>Digital FX Design Sub-Team Co-Lead</p>
        </div>
        
        <div class="team-member">
            <img src="team3.jpg" alt="Max Hayhurst">
            <p><strong>MAX HAYHURST</strong></p>
            <p>User Interface & Enclosure Sub-Team Lead</p>
        </div>
        
        <div class="team-member">
            <img src="team4.jpg" alt="Micah George">
            <p><strong>MICAH GEORGE</strong></p>
            <p>Micro Control Logic Sub-Team Lead</p>
        </div>
        ...
        <h3>And our faculty advisor, DR. JOHN BALL!</h3>
